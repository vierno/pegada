...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'core.appuser': {
            ...
            'shoe_size': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'core.shoe': {
            'Meta': {'object_name': 'Shoe'},
            'app_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.AppUser']"}),
            'foot': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
